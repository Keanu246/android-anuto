...
public final class GameSettings {
    ...
    public static final int START_CREDITS = 1500;
    public static final int START_LIVES = 25;
    public static final float DIFFICULTY_MODIFIER = 8e-2f;
    public static final float DIFFICULTY_EXPONENT = 1.5f;
    public static final float DIFFICULTY_LINEAR = 20;
    public static final float MIN_HEALTH_MODIFIER = 0.5f;
    public static final float REWARD_MODIFIER = 0.5f;
    public static final float REWARD_EXPONENT = 0.5f;
    public static final float MIN_REWARD_MODIFIER = 1f;
    public static final float EARLY_BONUS_MODIFIER = 2.5f;
    public static final float EARLY_BONUS_EXPONENT = 0.5f;
    public static final float TOWER_AGE_MODIFIER = 0.95f;
    public static final float WEAK_AGAINST_DAMAGE_MODIFIER = 2.5f;
